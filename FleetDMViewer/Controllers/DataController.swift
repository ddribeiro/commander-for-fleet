...
class DataController: ObservableObject {
    ...
    @Published var allTokens = [Token(name: "macOS", platform: ["darwin"]), Token(name: "Windows", platform: ["windows"]), Token(name: "Linux", platform: ["rhel", "ubuntu"])]
    ...
    func hostsForSelectedFilter() -> [CachedHost] {
        ...
        print(String(describing: predicates))
